...
import { cleanupExpiredOAuthData } from "@/lib/oauth-security";
import SVG from "./componentes/SVG";

export default function LoginPage() {
  const { login, isLoading, error } = useGoogleAuth();

  // Limpa dados expirados ao carregar
  useEffect(() => {
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Faça login com sua conta Google</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 group disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
